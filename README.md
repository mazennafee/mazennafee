...
- **Frameworks:** ![Foundry](https://img.shields.io/badge/Foundry-%23FF4B11.svg?style=flat) ![Hardhat](https://img.shields.io/badge/Hardhat-%23FFF100.svg?style=flat&logo=hardhat&logoColor=black) ![Anchor](https://img.shields.io/badge/Anchor-Solana-blue)
- **Security Tools:** Slither, Echidna, Mythril, Cargo-audit.
- **Development:** Antigravity IDE, Linux (Ubuntu), Node.js.
